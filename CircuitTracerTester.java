...
public class CircuitTracerTester {
	...
	//unused reference that exists purely to ensure that CircuitTracer.java
	//is compiled before we try to test it
	@SuppressWarnings("unused")
	private static final CircuitTracer neverUsed = null;
